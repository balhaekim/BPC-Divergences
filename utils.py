...
def get_dataset(dataset, data_path, batch_size=1, subset="imagenette", args=None):
    ...
    if dataset == 'CIFAR10':
        ...
        data_path = '/mnt/gsai/jwchoi/MetaSGMCMC/ref/mtt-distillation/buffers/d6_no_aug/data/ILSVRC2012/'
        channel = 3
        im_size = (128, 128)
        num_classes = 10
...
def evaluate_synset(it_eval, net, images_train, labels_train, testloader, args, Epoch=1000, return_loss=False):
    net = net.to(args.device)
...
def get_eval_pool(eval_mode, model, model_eval):
    if eval_mode == 'M': # multiple architectures
        ...
        model_eval_pool = ['MLP', 'ConvNet', 'AlexNet', 'VGG11', 'ResNet18_AP', 'ResNet18']
