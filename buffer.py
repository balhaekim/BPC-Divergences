...
def main(args):
    ...
    channel, im_size, num_classes, class_names, mean, std, dst_train, \
        dst_test, testloader, loader_train_dict, class_map, class_map_inv \
    ...
    for it in range(0, args.num_experts):
        ...
        teacher_net.train()
        lr = args.lr_teacher
        teacher_optim = torch.optim.SGD(teacher_net.parameters(), lr=lr, momentum=0, weight_decay=0)  
        ...
        for e in range(args.train_epochs):
            ...
            print("traic loss %.4f"%train_loss)
